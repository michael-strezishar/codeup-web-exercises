...
function calculateTip (percentage, total) {
    ...
    var tipMessage = ("The tip should be " + tip);
    return tipMessage;
...
var tipAmount = alert(calculateTip(percentage, billTotal));
...
function applyDiscount (price, discount) {
    ...
    var discountPercent = ((discount/100) * price);
    var discountedPrice = (originalPrice - discountPercent);
    return discountedPrice
}

var price = prompt("How much is the item? ");
var discount = prompt("How much is the discount? ");
